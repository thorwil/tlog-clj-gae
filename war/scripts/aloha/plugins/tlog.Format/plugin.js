...
*
* Customized Format plugin to replace <b> and <i> with <strong> and <emphasis>
*/


GENTICS.Aloha.Format = new GENTICS.Aloha.Plugin("tlog.Format");
GENTICS.Aloha.Format.languages = ["en"];
GENTICS.Aloha.Format.config = ["strong", "em", "del", "sub", "sup", "p", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "removeFormat"];
